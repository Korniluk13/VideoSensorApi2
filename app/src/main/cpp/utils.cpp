...
void initializeGlobalFields(JNIEnv *env) {
    ...
    {   // Image
        jclass imageClazz = env->FindClass("com/stabilizer/stabilizer/CodecImage");
        ...
        gFields.methodPlanes = env->GetMethodID(
                imageClazz, "getPlanes", "()[Lcom/stabilizer/stabilizer/CodecImage$Plane;");
    ...
    {   // Image.Plane
        jclass planeClazz = env->FindClass("com/stabilizer/stabilizer/CodecImage$Plane");
...
Java_com_stabilizer_stabilizer_CodecUtils_copyFlexYUVImage__Lcom_stabilizer_stabilizer_CodecImage_2Lcom_stabilizer_stabilizer_CodecImage_2(
...
JNIEXPORT void JNICALL
Java_com_stabilizer_stabilizer_CodecUtils_matToImage(JNIEnv *env, jclass type, jlong addr,
                                                     jobject dst) {
