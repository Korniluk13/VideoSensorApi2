...
//    private MediaRecorder mMediaRecorder;
     ...
     * @return The optimal {@code Size}, or an arbitrary one if none were big enoughYUV420Flexible
     */
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            // конретно отличается от width и height, обявленных выше 1024x768
            mVideoSize = chooseVideoSize(map.getOutputSizes(MediaRecorder.class));
            // mVideoSize = new Size(width, height);
            // mVideoSize = new Size()
            // это штука возращает еше что-то 3983
            mPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
                    width, height, mVideoSize);

            // непонято какие ширина и высота, ex: 1440x2560
...
//        builder.set(CaptureRequest.CONTROL_MODE, CameraMetadata.CONTROL_MODE_AUTO);
    ...
    private void startRecordingVideo() {
        ...
        try {
            ...
            recordingThread = new Thread(mVideoEncoder);
                    ...
                    if (img != null) {
                        ...
                        if (mIsRecordingVideo) {
                           ...
                           /* if(firstCall) {
                            ...
                            mVideoEncoder.addImageToVideo(img);
                        }
